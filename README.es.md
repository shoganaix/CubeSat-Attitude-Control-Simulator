...
- **Frames**: ECI (inercial, J2000-like), BODY, LVLH (nadir). Vector solar por defecto fijo en ECI (ephemeris real en roadmap).
...
- **M1**: detumbling (B-dot) y estimador TRIAD + MEKF con los sensores ya modelados.
